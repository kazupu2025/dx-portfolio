...
CARDS = [
    ...
    {"system_id": "defect_pareto", "metric": "top_pareto_count",
     "title": "パレート上位モード数", "fmt": lambda v: f"{int(v)}種"},
    {"system_id": "8d_effectiveness", "metric": "effective_ratio",
     "title": "処置有効率",          "fmt": lambda v: f"{v:.1f}%"},
    {"system_id": "quality_roi",      "metric": "roi",
     "title": "品質投資ROI",         "fmt": lambda v: f"{v:.1f}%"},
    {"system_id": "aql_sampling",     "metric": "avg_pa",
     "title": "AQL合格確率",         "fmt": lambda v: f"{v:.3f}"},
    ...
    {"system_id": "4m_change", "metric": "count",
     "title": "4M変更月次平均", "fmt": lambda v: f"{v:.1f}件"},
    {"system_id": "shipping_inspection", "metric": "pass_rate",
