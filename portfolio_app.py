...
_A_TOOL_DEFS = [
    ...
    ("B-35", "06_restaurant/02_cost_management/app.py",   "demo_cost_mgmt",    "[B-35] 飲食 原価・食材ロス管理"),
    ...
    ("B-39", "03_healthcare/03_medicine_inventory/app.py","demo_medicine",     "[B-39] 医療 薬品在庫・発注アラート"),
