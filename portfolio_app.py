...
_A_TOOL_DEFS = [
    ...
    ("B-62", "agriculture/01_harvest_quality/app.py",   "demo_agri_harvest",  "[B-62] 農業 収穫量・品質分析"),
    ("B-63", "agriculture/02_agri_cost/app.py",         "demo_agri_cost",     "[B-63] 農業 農薬・肥料コスト分析"),
    ("B-64", "agriculture/03_sales_channel/app.py",     "demo_agri_sales",    "[B-64] 農業 出荷先別販売分析"),
    ...
    ("B-72", "11_construction/05_cost_budget/app.py",   "demo_const_budget",  "[B-72] 建設 工事原価・予算実績管理"),
    ("B-73", "01_retail/06_shift_optimization/app.py",  "demo_retail_shift",  "[B-73] 小売 シフト充足率・人件費最適化"),
    ("B-74", "12_agriculture/02_staff_efficiency/app.py","demo_agri_staff",   "[B-74] 農業 農場スタッフ作業効率分析"),
    ("B-75", "02_manufacturing/04_production_variance/app.py", "demo_mfg_prod_var",  "[B-75] 製造 生産計画差異ダッシュボード"),
    ("B-76", "02_manufacturing/01_quality_inspection/app.py",  "demo_mfg_qc_insp",   "[B-76] 製造 品質検査 異常値検出ダッシュボード"),
    ("B-77", "02_manufacturing/02_equipment_log/app.py",       "demo_mfg_equip_log", "[B-77] 製造 設備稼働ログ 異常予兆検知"),
    ...
    ("B-84", "02_manufacturing/14_corrective_action/app.py", "demo_mfg_capa",      "[B-84] 製造 CAPA（是正処置）効果検証"),
    ("B-85", "02_manufacturing/18_aql_sampling/app.py",      "demo_mfg_aql",       "[B-85] 製造 AQL抜き取り検査・ロット合否判定"),
    ("B-86", "02_manufacturing/17_supplier_scoring/app.py",  "demo_mfg_supplier",  "[B-86] 製造 サプライヤー品質スコアリング"),
    ("B-87", "02_manufacturing/05_material_cost/app.py",    "demo_mfg_matcost",   "[B-87] 製造 原材料コスト変動ダッシュボード"),
    ("B-88", "02_manufacturing/11_gauge_rr/app.py",         "demo_mfg_grr",       "[B-88] 製造 ゲージR&R（MSA）測定システム解析"),
    ("B-89", "02_manufacturing/12_4m_change/app.py",        "demo_mfg_4mchange",  "[B-89] 製造 4M変更前後 品質比較"),
]
