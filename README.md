...
![Demos](https://img.shields.io/badge/Live_demos-45_tools-3b82f6)
...
45 ツールをブラウザで即体験できます。クレカ登録・インストール不要。

---

## 📸 スクリーンショット

### ツールカタログ（128 システムを一覧・フィルタリング）
...
| 💰 | **金融・費用管理** 出張費上限超過アラート、与信スコアの自動算出・リスク分類 | A-04 出張費集計 / B-11 与信スコア |
| 👥 | **勤怠・研修** 残業アラート・研修効果測定スコアカード | A-05 / C-111 研修効果 |
...
**全 15 業種 × 128 システム**をカバー。ライブデモ **45 本**（A 系 8 本・B 系 10 本・C 系 27 本）をブラウザで即体験可能。
